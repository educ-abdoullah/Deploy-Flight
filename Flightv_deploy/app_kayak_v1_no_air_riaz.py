...
DEFAULT_DEPART_START = "2026-06-25"
DEFAULT_DEPART_END   = "2026-07-01"
DEFAULT_RETURN_START = "2026-08-25"
...
OUTLOOK_TO = ["avahid@yahoo.fr","cr7.mujeebur@gmail.com"]
      ...
      <body style="margin:0;padding:0;background:#f6f8fb;">
        <div style="padding:18px;">
          ...
          <div style="max-width:920px;margin:0 auto;background:#ffffff;border:1px solid #e7ebf3;border-radius:16px;overflow:hidden;">
            ...
            <!-- Header -->
            <div style="padding:18px 18px 14px 18px;border-bottom:1px solid #edf0f5;">
              <div style="font-family:Segoe UI, Arial;font-size:15px;color:#111111;line-height:1.45;">
                Bonjour Riaz,<br>
              ...
              <div style="font-family:Segoe UI, Arial;font-size:13px;color:#333333;line-height:1.55;">
                <div style="font-weight:800;margin-bottom:6px;">Critères de recherche appliqués</div>
                <div style="color:#374151;">
                  Vol aller-retour au départ de <b>CDG (Paris)</b> vers <b>MAA (Chennai)</b> pour <b>2 passagers</b>,
                  départ entre le <b>25/06/2026</b> et le <b>01/07/2026</b>,
                  retour entre le <b>25/08/2026</b> et le <b>30/08/2026</b>,
                  max <b>1 escale</b>, durée max <b>22h</b>,
                  compagnies exclues : <b>AI</b>, <b>BA</b>, <b>LH</b>.
                </div>
              </div>
              ...
              <div style="font-family:Segoe UI, Arial;font-size:13px;color:#333333;line-height:1.55;">
                ...
                <div style="color:#6b7280;font-size:12px;margin-top:4px;">
                  Règle : pas deux offres avec la même <b>compagnie</b> et le même <b>jour de départ</b>.
                </div>
              </div>
            </div>
...
def export_pdf_and_outlook_send():
    ...
    subject = f"Vols Kayak Riaz - {today}"
